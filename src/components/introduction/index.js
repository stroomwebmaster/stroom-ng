				...
				<div class="container mx-auto">
					...
					>
						<div class="col-span-4 md:col-start-2 lg:col-start-2 md:col-span-7 lg:col-span-11">
							<h2 class="uppercase text-turquoise text-xl md:text-3xl lg:text-4xl leading-normal md:leading-normal lg:leading-normal font-black font-HelveticaNeueLTPro-BlkEx">{this.props.content?.newsletterTitle}</h2>
						</div>
