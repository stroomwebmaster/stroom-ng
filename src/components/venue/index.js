    ...
    render() {
        return (
            <article class="bg-coal w-hd-80 xl:ml-auto relative">
                <img src="./assets/venue.jpg" class={`w-full ${style.locationPhoto}`} />
                <div class="container mx-auto relative -top-20">
                    <div class="grid md:grid-cols-8 lg:grid-cols-12 bg-orange lg:mt--40 border-b-8 border-turquoise py-8 md:py-12">
                        <div class="col-span-4 md:col-span-8 lg:col-span-10 lg:col-start-2 text-coal text-sm md:text-lg lg:text-2xl leading-relaxed md:leading-relaxed lg:leading-relaxed font-HelveticaNeueLTPro-Ex">
